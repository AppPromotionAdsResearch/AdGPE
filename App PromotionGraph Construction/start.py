...
def parse_args():
    ...
    parser.add_argument("-policy", action="store", dest="input_policy", default=input_manager.DEFAULT_POLICY,
                        help='Policy to use for test input generation. '
                             ...
                             '  \"%s\" -- Explore UI using a ad-oriented greedy breadth-first strategy;\n'
                             '  \"%s\" -- Explore UI using a ad-oriented greedy depth-first strategy;\n'
                             %
                             (
                                 ...
                                 input_policy.POLICY_AD_BFS,
                                 input_policy.POLICY_AD_DFS
                             ))
...
def main():
    ...
    if start_mode == "master":
        ...
        droidbot = DroidBot(
            ...
            replay_output=opts.replay_output)
        droidbot.start()
    return droidbot.input_manager.policy.ads
